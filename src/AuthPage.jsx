...
const handleForgotPassword = async (email) => {
  ...
  const { error } = await supabase.auth.resetPasswordForEmail(email, {
    redirectTo: "http://localhost:5177/reset-password", // الرابط التجريبي
  });
...
export default function AuthForm({
  ...
  return (
   <div className="relative min-h-screen flex items-center justify-center p-6" style={{ backgroundColor: "#eafe6a" }}>
