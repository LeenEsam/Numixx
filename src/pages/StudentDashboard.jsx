...
>
  ...
  >
    إغلاق
        ...
        {/* Main content* */}
        <div className="flex-1 p-6 z-6" style={{ backgroundColor: "#eafe6a" }}>
...
>
  ...
  <div className="mt-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 ">
     ...
     {/* GIF في أسفل الصفحة بالزاوية اليمنى */}

<div className="fixed bottom-4 right-4 w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 -z-1">
  <img
    src="./src/assets/gif/Thinking Calculating GIF by Camp Farmcreek.gif"
    alt="متحركة"
